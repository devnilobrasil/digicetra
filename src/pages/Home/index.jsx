...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Hero Section */}
      <div
        className="relative bg-cover bg-center h-[60vh] bg-hero-image"
      
      >
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#171B1E]"></div>
        <div className="relative flex flex-col items-start justify-center h-full text-left text-[#fff] mx-5 md:mx-32">
      ...
      <div className="md:py-20 bg-[#171B1E]">
       ...
       <div
  className="h-auto flex flex-col items-center justify-center bg-cover bg-center bg-solutions-image"
>
  ...
  <div className="py-12 w-full">
    <div className="container mx-auto">
      <h2 className="text-white text-3xl font-bold text-center mb-8 ml-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Turnkey Card */}
        <div className="bg-[#292929] text-white rounded-xl p-6 shadow-lg m-5 md:col-span-2 lg:col-span-1 md:mx-auto">
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col gap-10">
        <div className="flex items-center mb-4">
          <div className="text-blue-600 mx-3">
            <img src="sportsbook2.png" className="h-16" alt={t('platform.cards.sportsbook.title')} />
          </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col gap-10">
        <div className="flex items-center mb-4">
          <div className="text-blue-600 mx-3">
            <img src="bonus.png" className="h-16" alt={t('platform.cards.bonusEngine.title')} />
          </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col gap-10">
        <div className="flex items-center mb-4">
          <div className="text-blue-600 mx-3">
            <img src="payment.png" className="h-16" alt={t('platform.cards.paymentSystem.title')} />
          </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col gap-10">
        <div className="flex items-center mb-4">
          <div className="text-blue-600 mx-3">
            <img src="retail.png" className="h-16" alt={t('platform.cards.retail.title')} />
          </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col gap-10">
        <div className="flex items-center mb-4">
          <div className="text-blue-600 mx-3">
            <img src="CRM.png" className="h-16" alt={t('platform.cards.crm.title')} />
          </div>
    ...
    >
      <div className="relative z-10 flex flex-col items-start justify-center h-full text-left text-white mx-5 md:mx-14">
